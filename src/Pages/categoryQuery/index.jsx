            ...
            <Card className={style.card}>
              <div className={style.option} style={{ height: '30px', lineHeight: '30px' }} onClick={() => { this.select('所有') }}>
                ...
                <div style={{ marginTop: '5px' }}>
                  <svg style={{ display: this.state.category[0] === '所有' ? 'block' : 'none' }} t="1622363644700" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2412" width="20" height="20"><path d="M341.6 780.1c39.5-88.9 82.1-174.6 127.8-257.4 45.7-82.6 94.7-161 147.3-235.3 52.6-74.3 92.8-125.1 120.4-152.7s46.8-43.7 57.5-48.4c10.6-4.7 34-9.6 70.3-14.7s61.1-7.7 74.6-7.7c8.5 0 12.9 3.3 12.9 9.8 0 4.1-1.5 8.1-4.6 11.9-3 3.9-11.9 12.4-26.5 25.3-73.7 68.6-154.8 169.6-243.1 303.4C589.8 548.2 516 688.6 456.5 835.8c-24.1 58.8-40.5 94-49.5 105.8-9 12.3-37.3 18.3-84.9 18.3-34.2 0-54.7-3.5-61.4-10.4s-20.2-25.8-40.7-56.8c-33.4-51.6-72-100.5-115.4-146.4-22-23.1-32.9-40.7-32.9-52.5 0-16.2 11.9-32.8 36-49.8 23.9-16.9 43.8-25.3 59.7-25.3 20.3 0 45.3 11.2 74.9 33.5 29.6 22.9 62.7 65.4 99.3 127.9z" p-id="2413"></path></svg>
                </div>
              </div>
            </Card>
            <Card className={style.card}>
              {keys.map(item => {
                return <div className={style.option} key={random(1, 10000, false)} onClick={() => { this.select(item) }}>
                  ...
                  <div className={style.svg}>
                    <svg style={{ display: this.state.category[0] === item ? 'block' : 'none' }} t="1622363644700" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2412" width="20" height="20"><path d="M341.6 780.1c39.5-88.9 82.1-174.6 127.8-257.4 45.7-82.6 94.7-161 147.3-235.3 52.6-74.3 92.8-125.1 120.4-152.7s46.8-43.7 57.5-48.4c10.6-4.7 34-9.6 70.3-14.7s61.1-7.7 74.6-7.7c8.5 0 12.9 3.3 12.9 9.8 0 4.1-1.5 8.1-4.6 11.9-3 3.9-11.9 12.4-26.5 25.3-73.7 68.6-154.8 169.6-243.1 303.4C589.8 548.2 516 688.6 456.5 835.8c-24.1 58.8-40.5 94-49.5 105.8-9 12.3-37.3 18.3-84.9 18.3-34.2 0-54.7-3.5-61.4-10.4s-20.2-25.8-40.7-56.8c-33.4-51.6-72-100.5-115.4-146.4-22-23.1-32.9-40.7-32.9-52.5 0-16.2 11.9-32.8 36-49.8 23.9-16.9 43.8-25.3 59.7-25.3 20.3 0 45.3 11.2 74.9 33.5 29.6 22.9 62.7 65.4 99.3 127.9z" p-id="2413"></path></svg>
                  </div>
                </div>
              })}
            </Card >
          ...
          <Card className={style.card}>
            {arr.map(item => {
              ...
              return <div className={style.option} key={random(1, 10000, true)} onClick={() => { this.select(item) }}>
                <div>{item}</div>
                <div className={style.svg}>
                  <svg t="1622363644700" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2412" width="20" height="20" style={{ display: flag ? 'block' : 'none' }}><path d="M341.6 780.1c39.5-88.9 82.1-174.6 127.8-257.4 45.7-82.6 94.7-161 147.3-235.3 52.6-74.3 92.8-125.1 120.4-152.7s46.8-43.7 57.5-48.4c10.6-4.7 34-9.6 70.3-14.7s61.1-7.7 74.6-7.7c8.5 0 12.9 3.3 12.9 9.8 0 4.1-1.5 8.1-4.6 11.9-3 3.9-11.9 12.4-26.5 25.3-73.7 68.6-154.8 169.6-243.1 303.4C589.8 548.2 516 688.6 456.5 835.8c-24.1 58.8-40.5 94-49.5 105.8-9 12.3-37.3 18.3-84.9 18.3-34.2 0-54.7-3.5-61.4-10.4s-20.2-25.8-40.7-56.8c-33.4-51.6-72-100.5-115.4-146.4-22-23.1-32.9-40.7-32.9-52.5 0-16.2 11.9-32.8 36-49.8 23.9-16.9 43.8-25.3 59.7-25.3 20.3 0 45.3 11.2 74.9 33.5 29.6 22.9 62.7 65.4 99.3 127.9z" p-id="2413"></path></svg></div>
              </div>
            })}
          </Card>
        </ div>
